...
///////////////////////////////////////////////////////////////////
  ...
  h_wj = (TH1F *)f01->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    h_wj->SetLineColor(1);
    h_wj->SetFillColor(kAzure+6);
    h_wj->Scale(1);
  h_dy = (TH1F *)f02->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    h_dy->SetLineColor(1);
    h_dy->SetFillColor(kOrange-4);
    //h_dy->Scale(0.98);
  h_tt = (TH1F *)f03->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    h_tt->SetLineColor(1);
    h_tt->SetFillColor(kBlue-8);
  h_st = (TH1F *)f04->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    h_st->SetLineColor(1);
    h_st->SetFillColor(8);
  h_vv = (TH1F *)f06->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    h_vv->SetLineColor(1);
    h_vv->SetFillColor(46);
  h_ratio = (TH1F *)f901->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
  h_data = (TH1F *)f900->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
    //h_data->Scale(8.9);
  ...
  h_back = (TH1F *)f00->Get("NDiJetCombinations/DiTauReconstructableMassDeltaPt");
  h_back->Sumw2();
  h_back->Add(h_dy);
  h_back->Add(h_tt);
  h_back->Add(h_st);
  ...
  //gPad->SetLogy();
   ...
   //hs_n->SetTitle("CMS Preliminary                 35.9 fb^{-1} (13 TeV, 2016) ;  ; Events");
    ...
    TPaveText *pt = new TPaveText(0.11,0.94,0.99,0.99,"NBNDC");
      pt->AddText("Drell-Yan CR                 59.7 fb^{-1} (13 TeV, 2018)");
      pt->SetTextFont(42);
      pt->SetTextAlign(32);
      pt->SetFillStyle(0);
      pt->SetBorderSize(0);
